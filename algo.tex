...
\input{chapters/0-vorwort-einleitung}

\input{chapters/1-komplexitaet}

\input{chapters/2-rekursionen}

\input{chapters/3-suchen}

\input{chapters/4-sortieren}

\input{chapters/5-dynamische-mengen}

\input{chapters/9-dynamisches-programmieren}

\input{chapters/6-hashing}

\input{chapters/7-graphen}

\input{chapters/8-patternmatching}
